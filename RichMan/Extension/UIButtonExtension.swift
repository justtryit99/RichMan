...
extension UIButton {
    ...
    //定位按鈕
    func location(){
        self.setImage(UIImage(named:"ic_location-default"),for:.normal)
        self.setImage(UIImage(named:"ic_location-tap"),for:.highlighted)
    }

    //收藏按鈕
    func setCollectBtn() {
        self.setImage(UIImage(named:"ic_love-tap_28x28"),for:.highlighted)
    }
